export const projectsData = [
    ...
    },
    {
        ...
        I originally built this game using only frontend code, just for myself to play. However, some friends expressed an interest in playing and I wanted to be able to track everyone’s game statistics, both of which lead to me expanding the game into a full-stack application which facilitates user sign-in and tracking of user-specific game statistics (things like number of games played, win percentage, current streak, best streak, and the guess distribution of the user’s wins). The game now has over 20 signed-up users and around 50 daily active players!
